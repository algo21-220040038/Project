...
class EventEngine():
    ...
    def save_ebook(self, event):
        ...
        c.execute(
            ...
            [event.data.datetime, event.data.bid_price_1, event.data.bid_price_2, event.data.bid_price_3,
             event.data.bid_price_4, event.data.bid_price_5,
             event.data.ask_price_1, event.data.ask_price_2, event.data.ask_price_3, event.data.ask_price_4,
             event.data.ask_price_5,
             event.data.bid_volume_1, event.data.bid_volume_2, event.data.bid_volume_3, event.data.bid_volume_4,
             event.data.bid_volume_5,
             event.data.ask_volume_1, event.data.ask_volume_2, event.data.ask_volume_3, event.data.ask_volume_4,
             event.data.ask_volume_5])
    ...
    def save_etick(self, event):
        ...
        c.execute(
            ...
            [event.data.datetime, event.data.volume, event.data.open_interest, event.data.last_price,
             event.data.last_volume,
